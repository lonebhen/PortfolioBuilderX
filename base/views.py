...
from base.serializers import (userSerializer, informationSerializer, educationSerializer, experienceSerializer, projectSerializer, skillsetSerializer, messageSerializer)
...
def introForm_createView(request, *args, **kwargs):
    template_name = 'interface/information_create.html'
    context = {}
    user = request.user
...
def eduForm_createView(request, *args, **kwargs):
    template_name = 'interface/education_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        user = "admin"
...
def expForm_createView(request, *args, **kwargs):
    template_name = 'interface/experience_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def projectForm_createView(request, *args, **kwargs):
    template_name = 'interface/project_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def skillForm_createView(request, *args, **kwargs):
    template_name = 'interface/skill_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def portfolio_view(request, username, *args, **kwargs):
    template_name = 'interface/portfolio.html'
    context = {}
...
def introForm_updateView(request, *args, **kwargs):
    template_name = 'interface/update/information_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def eduForm_updateView(request, id, *args, **kwargs):
    template_name = 'interface/update/education_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def expForm_updateView(request, id,  *args, **kwargs):
    template_name = 'interface/update/experience_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def projectForm_updateView(request, id, *args, **kwargs):
    template_name = 'interface/update/project_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
#Skillset update form view
@login_required(login_url='login')
def skillForm_updateView(request, id, *args, **kwargs):
    template_name = 'interface/update/skill_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def login_view(request, *args, **kwargs): 
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return render(request, "interface/loginRegister.html", {"message": "Invalid username or password. Please check again!"})
    else:
        return render(request, "interface/loginRegister.html", {"message": ""})
...
def register_view(request, *args, **kwargs):
    if request.method == "POST":
        ...
        if password != confirmation:
            return render(request, "interface/loginRegister.html", {"message": "Password not confirmed/matching. Please enter again."})
